...
int isDelete;
    ...
    public Product(int id, String name, String description, int price, int stock, int categoryLevel1Id, int categoryLevel2Id, int categoryLevel3Id, String fileName, int isDelete) {
        this.id = id;
        this.name = name;
