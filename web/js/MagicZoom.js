...
function MagicZoom(smallImageContId, smallImageId, bigImageContId, bigImageId, settings) {
    ...
    this.big./imagesizeX = 0;
    this.big./imagesizeY = 0;
    this.small./imagesizeX = 0;
    this.small./imagesizeY = 0;
    this.popupSizeX = 20;
    this.popupSizey = 20;
    this.positionX = 0;
    this.positionY = 0;
...
MagicZoom.prototype.checkcoords = function(e) {
    ...
    if (x > parseInt(smallX + this.small./imagesizeX)) {
        this.hiderect();
        return false
    }
    ...
    if (y > parseInt(smallY + this.small./imagesizeY)) {
        this.hiderect();
        return false
    }
...
MagicZoom.prototype.mousemove = function(e) {
    ...
    if ((this.positionX + this.popupSizeX / 2) >= this.small./imagesizeX) {
        this.positionX = this.small./imagesizeX - this.popupSizeX / 2
    }
    if ((this.positionY + this.popupSizeY / 2) >= this.small./imagesizeY) {
        this.positionY = this.small./imagesizeY - this.popupSizeY / 2
    }
...
MagicZoom.prototype.showrect = function() {
    ...
    perX = parseInt(this.pup.style.left) * (this.big./imagesizeX / this.small./imagesizeX);
    perY = parseInt(this.pup.style.top) * (this.big./imagesizeY / this.small./imagesizeY);
...
MagicZoom.prototype.recalculatePopupDimensions = function() {
    this.popupSizeX = (parseInt(this.bigImageCont.style.width) - 0) / (this.big./imagesizeX / this.small./imagesizeX);
    if (this.settings && this.settings["header"] != "") {
        this.popupSizeY = (parseInt(this.bigImageCont.style.height) - 0 - 0) / (this.big./imagesizeY / this.small./imagesizeY)
    } else {
        this.popupSizeY = (parseInt(this.bigImageCont.style.height) - 0) / (this.big./imagesizeY / this.small./imagesizeY)
    }
    if (this.popupSizeX > this.small./imagesizeX) {
        this.popupSizeX = this.small./imagesizeX
    }
    if (this.popupSizeY > this.small./imagesizeY) {
        this.popupSizeY = this.small./imagesizeY
    }
...
MagicZoom.prototype.initZoom = function() {
    ...
    this.big./imagesizeX = this.bigImage.width;
    this.big./imagesizeY = this.bigImage.height;
    this.small./imagesizeX = this.smallImage.width;
    this.small./imagesizeY = this.smallImage.height;
    if (this.big./imagesizeX == 0 || this.big./imagesizeY == 0 || this.small./imagesizeX == 0 || this.small./imagesizeY == 0) {
        setTimeout(MagicZoom_createMethodReference(this, "initZoom"), 100);
        return
    }
    ...
    if (this.settings && this.settings["drag_mode"] == true) {
        ...
        this.positionX = this.small./imagesizeX / 2;
        this.positionY = this.small./imagesizeY / 2;
        this.showrect()
    }
};
