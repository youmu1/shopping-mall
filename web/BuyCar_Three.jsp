<%@ page import="com.servlet.BuyCar3" %>
<%@ page import="com.pojo.Show3" %><%--
...
<%
    ...
    if (session1!=null) {
        show3 = (Show3) session1.getAttribute("show");
        if (show3.getWhatpay() == null)response.sendRedirect("login.jsp");
        if (show3.getWhatpay().equals("0"))pay = "余额支付";
        if (show3.getWhatpay().equals("1"))pay = "银行转账";
        if (show3.getWhatpay().equals("2"))pay = "货到付款";
        if (show3.getWhatpay().equals("3"))pay = "支付宝";

        if (Integer.parseInt(show3.getPeisong())==1)song = "申通快递";
        if (Integer.parseInt(show3.getPeisong())==2)song = "城际快递";
        if (Integer.parseInt(show3.getPeisong())==3)song = "邮局平邮";
    }
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
                <tr height="35">
                    <td style="font-size:18px;">
                        感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00"><%=show3.getId()%></font>
                    </td>
                </tr>
                <tr>
                    <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                        您选定的配送方式为: <font color="#ff4e00"><%=song%></font>； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00"><%=pay%></font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<%=show3.getMoney()%></font>
                    </td>
                </tr>
                <tr>
