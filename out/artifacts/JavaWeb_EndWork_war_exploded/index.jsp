                ...
                <ul>
                    ...
                    <li>
                        <div class="fj">
                            ...
                            <span class="fl"><a href="categorylist"> 美妆、个人护理、洗护</a></span>
                        </div>
...
<%--                            $("#news").html("<li><span>[ 特惠 ]</span><a href=\"#\">"+obj.title+"</a></li>");--%>
<%--                        });--%>
<%--                    }--%>
<%--                });--%>
<%--                }--%>
<%--            </script>--%>
            <ul id="news">
                ...
                HttpSession session1 = request.getSession();
                    ArrayList<News> arrayList = (ArrayList<News>)session1.getAttribute("news");
                    for(News ia:arrayList) {
                    out.write("<li><span>[ 特惠 ]</span><a href=\"#\">"+ia.getTitle()+"</a></li>");
                    }
